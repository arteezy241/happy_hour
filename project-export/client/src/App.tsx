...
import { ShoppingCart, Home as HomeIcon, Store, Menu, X, Sun, Moon, Users, Info, HelpCircle, Facebook } from "lucide-react"; 
...
function Navigation() {
  ...
  // FIX 1: Defined Facebook Link and other constants once here
  const facebookLink = "https://www.facebook.com/share/1A6XXm1efa/";
  ...
  return (
    <nav className="bg-white/80 dark:bg-black/80 backdrop-blur-md border-b dark:border-gray-800 sticky top-0 z-50 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          
          {/* --- BRAND AND FACEBOOK ICON (LEFT SIDE) --- */}
          <div className="flex items-center gap-3">
            ...
            >
              <Facebook size={24} className="text-blue-600 dark:text-blue-500" />
            </a>
            <Link href="/">
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/team" component={Cover} /> 
